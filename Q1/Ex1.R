...
dag_solvency = dag(c("R"), c("Ac", "R"), c("DvsR", "Ag"), c("H", "DvsR"), c("Ag"), c("Fi", "H", "Ag"), c("Rf", "Ac"), c("S", "Fi", "Rf", "DvsR"), result = "graphNEL")
...
cp_Fi <- cptable(~Fi|Ag+H,values=c(0.6,0.4, 0.3,0.7, 0.2,0.8, 0.1,0.9,   0.7, 0.3, 0.1, 0.9),levels=val_F_NF) # à modif 
cp_S <- cptable(~S|Rf+Fi+DvsR,values=c(0.4,0.6, 0.3,0.7, 0.2,0.8,   0.8,0.2, 0.2,0.8,   0.4,0.6, 0.3,0.7, 0.2,0.8),levels=val_S_NS) # à modif
...
# 8. Les personnes qui ont des revenus prometteurs ont plus de chance d’être solvables
#    que celles dont la perspective des revenus à venir est mauvaise.
